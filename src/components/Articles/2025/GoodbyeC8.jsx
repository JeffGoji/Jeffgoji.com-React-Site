        ...
        <Container fluid className="article-page">
            ...
            <Row className="justify-content-center mt-3">
                <Col>
                    ...
                    <p>Another positive is the design of the car. The C8 has a sleek and modern look that turns heads wherever it goes. It also invites lots of questions and random conversations from various people about the car whenever it's parked in public spots.
                    </p>
                    <p>The interior of the first generation C8 (2020 to 2024) is a winner for me. Everything about it is functional and is focused like  cockpit in a fighter jet for the driver. There is the infamous "wall of buttons" between the seats which can lead to a tiny amount of passenger discomfort, but it makes AC and ventilated/heated seat control very easy to access for the passenger.
