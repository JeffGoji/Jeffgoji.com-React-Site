import Pic1 from '../../assets/images/na/6ul05.jpg'
        ...
        <div className='container-fluid mt-5'>
            <div className='row mb-5'>
                ...
                <div className='col-lg-12 col-sm-12 text-center'>
                    <img src={Pic1} alt="NA Miata" className='img-fluid img-rounded img-shadow mt-5 mb-3' />
                </div>
                ...
                <div className="col-lg-6 col-sm-12 mt-5">
                    <p>I bought this 1991 Miata on February 23rd 2003, and I'm the third owner.
                        The car is pretty amazing
                    </p>
                </div>
            </div>
        </div>
